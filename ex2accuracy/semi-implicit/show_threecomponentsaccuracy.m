...
ss=sprintf('./accuracy/datac.m'); accuracyphi = load(ss);
ss=sprintf('./accuracy/datac2.m'); accuracyphi2 = load(ss);
ss=sprintf('./accuracy/datac3.m'); accuracyphi3 = load(ss);


ss=sprintf('./accuracy2dt/datac.m'); phidt2 = load(ss);
ss=sprintf('./accuracy2dt/datac2.m'); phi2dt2= load(ss);
ss=sprintf('./accuracy2dt/datac3.m'); phi3dt2 = load(ss);


ss=sprintf('./accuracy4dt/datac.m'); phidt4 = load(ss);
ss=sprintf('./accuracy4dt/datac2.m'); phi2dt4 = load(ss);
ss=sprintf('./accuracy4dt/datac3.m'); phi3dt4 = load(ss);




ss=sprintf('./accuracy8dt/datac.m'); phidt8 = load(ss);
ss=sprintf('./accuracy8dt/datac2.m'); phi2dt8 = load(ss);
ss=sprintf('./accuracy8dt/datac3.m'); phi3dt8 = load(ss);


ss=sprintf('./accuracy16dt/datac.m'); phidt16 = load(ss);
ss=sprintf('./accuracy16dt/datac2.m'); phi2dt16 = load(ss);
ss=sprintf('./accuracy16dt/datac3.m'); phi3dt16 = load(ss);
