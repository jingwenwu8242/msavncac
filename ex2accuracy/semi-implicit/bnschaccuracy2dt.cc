...
int main()
{
    ...
    sprintf(bufferc,"/Users/wujingwen/research/fluid_mechanics/2msavncac/msav+ncac/cacexample13componentaccuracy/semi-implicit/accuracy2dt/datac.m");
    sprintf(bufferc2,"/Users/wujingwen/research/fluid_mechanics/2msavncac/msav+ncac/cacexample13componentaccuracy/semi-implicit/accuracy2dt/datac2.m");
    sprintf(bufferc3,"/Users/wujingwen/research/fluid_mechanics/2msavncac/msav+ncac/cacexample13componentaccuracy/semi-implicit/accuracy2dt/datac3.m");
   ...
   save as row//
    ...
    myr = fopen("/Users/wujingwen/research/fluid_mechanics/2msavncac/msav+ncac/cacexample13componentaccuracy/semi-implicit/accuracy2dt/Mene.m","w");
    myq = fopen("/Users/wujingwen/research/fluid_mechanics/2msavncac/msav+ncac/cacexample13componentaccuracy/semi-implicit/accuracy2dt/Oene.m","w");
  ...
  orc =1;
   ...
   ijloop{
      ...
      H1[i][j] = c[i][j]*(c[i][j]-0.5)*(c[i][j]-1.0);
      H2[i][j] = c2[i][j]*(c2[i][j]-0.5)*(c2[i][j]-1.0);
      H3[i][j] = c3[i][j]*(c3[i][j]-0.5)*(c3[i][j]-1.0);
    ...
    ijloop{
      ...
      H1[i][j] = intc1[i][j]*(intc1[i][j]-0.5)*(intc1[i][j]-1.0);
      H2[i][j] = intc2[i][j]*(intc2[i][j]-0.5)*(intc2[i][j]-1.0);
      H3[i][j] = intc3[i][j]*(intc3[i][j]-0.5)*(intc3[i][j]-1.0);
     }
     lagrangeH(H1,nx,ny);
      lagrangeH(H2,nx,ny);
      lagrangeH(H3,nx,ny);
     ...
     ijloop{
      ...
      EnEM = EnEM + h*h*( 
         ...
         + 0.5*SS/Cahn*( pow(nc[i][j]-oc[i][j],2)  + pow(nc2[i][j]-oc2[i][j],2)  + pow(1.0-nc[i][j]-nc2[i][j] - (1.0-oc[i][j]-oc2[i][j]),2)   )  );
