...
int main()
{
    ...
    gam = 2.0*h/(4.0*sqrt(2.0)*atanh(0.9));
    ...
    sprintf(bufferc,"/Users/wujingwen/research/fluid_mechanics/2msavncac/msav+ncac/eplison/data2/datac.m");
    sprintf(bufferc2,"/Users/wujingwen/research/fluid_mechanics/2msavncac/msav+ncac/eplison/data2/datac2.m");
    sprintf(bufferc3,"/Users/wujingwen/research/fluid_mechanics/2msavncac/msav+ncac/eplison/data2/datac3.m");
   ...
   save as row//
    ...
    myr = fopen("/Users/wujingwen/research/fluid_mechanics/2msavncac/msav+ncac/eplison/data2/Mene.m","w");
    myq = fopen("/Users/wujingwen/research/fluid_mechanics/2msavncac/msav+ncac/eplison/data2/Oene.m","w");
