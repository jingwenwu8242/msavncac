...
int main()
{
    ...
    gam = 3.0*h/(4.0*sqrt(2.0)*atanh(0.9));
    ...
    sprintf(bufferc,"/Users/wujingwen/research/fluid_mechanics/2msavncac/msav+ncac/eplison/data3/datac.m");
    sprintf(bufferc2,"/Users/wujingwen/research/fluid_mechanics/2msavncac/msav+ncac/eplison/data3/datac2.m");
    sprintf(bufferc3,"/Users/wujingwen/research/fluid_mechanics/2msavncac/msav+ncac/eplison/data3/datac3.m");
   ...
   save as row//
    ...
    myr = fopen("/Users/wujingwen/research/fluid_mechanics/2msavncac/msav+ncac/eplison/data3/Mene.m","w");
    myq = fopen("/Users/wujingwen/research/fluid_mechanics/2msavncac/msav+ncac/eplison/data3/Oene.m","w");
