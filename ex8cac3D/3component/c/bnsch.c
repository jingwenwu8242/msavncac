...
int main()
{
    ...
    myr = fopen("/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/example9cac3D/3component/c/dataout/Mene.m","w");
    myq = fopen("/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/example9cac3D/3component/c/dataout/Oene.m","w");
...
float Ef(float ***c, float ***c2, float ***c3, int nxt, int nyt, int nzt)
{
   ...
   ijkloopt{ r = r + h*h*h*( 0.25*pow(c[i][j][k],2)*pow(c[i][j][k]-1.0,2) + 0.25*pow(c2[i][j][k],2)*pow(c2[i][j][k]-1.0,2) 
...
void print_data(float ***c1,float ***c2,float ***c3,int kk)
{
   ...
   int i,j,k;
    ...
    sprintf(bufferc,"/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/example9cac3D/3component/c/dataout/datac1%d.m",kk);
    sprintf(bufferc2,"/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/example9cac3D/3component/c/dataout/datac2%d.m",kk);
    sprintf(bufferc3,"/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/example9cac3D/3component/c/dataout/datac3%d.m",kk);
