...
legend('Modified energy curves for (m_{1},m_{2},m_{3})=(1/3,1/3,1/3)','Original energy curves for (m_{1},m_{2},m_{3})=(1/3,1/3,1/3) ',...
'Modified energy curves for (m_{1},m_{2},m_{3})=(1/4,1/4,1/2)','Original energy curves for (m_{1},m_{2},m_{3})=(1/4,1/4,1/2) ',...
'Modified energy curves for (m_{1},m_{2},m_{3})=(1/5,1/5,3/5)','Original energy curves for (m_{1},m_{2},m_{3})=(1/5,1/5,3/5) ')
set(gca,'fontsize',25);
xlabel('Time');
ylabel('Energy');
box on;
