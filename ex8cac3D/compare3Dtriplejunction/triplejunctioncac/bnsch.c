...
int main()
{
    ...
    gam = 0.0019;//4.0*h/(4.0*sqrt(2.0)*atanh(0.9));
    Cahn = pow(gam,2);
    M = 1;
    ...
    myr = fopen("/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/example9cac3D/compare3Dtriplejunction/triplejunctioncac/dataout/Mene.m","w");
    myq = fopen("/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/example9cac3D/compare3Dtriplejunction/triplejunctioncac/dataout/Oene.m","w");
...
void initialization(float ***c, float ***c2, float ***c3, float ***c4)
{
   ...
   c[i][j][k] = c2[i][j][k] = c3[i][j][k]= 0;

        if (x>=0.25 && x<=0.75 && y>=0.25 && y<=0.75 && z>=0.58 && z<=0.75)
            c[i][j][k] = 1.0;
        if (x>=0.25 && x<=0.5 && y>=0.25 && y<=0.75 && z>=0.25 && z<=0.58)
            c2[i][j][k] = 1.0;
        if (x>=0.5 && x<=0.75 && y>=0.25 && y<=0.75 && z>=0.25 && z<=0.58)
            c3[i][j][k] = 1.0;
        c4[i][j][k] = 1.0 - c[i][j][k] - c2[i][j][k]-c3[i][j][k];   
...
void print_data(float ***c1,float ***c2,float ***c3, float ***c4, int kk)
{
   ...
   int i,j,k;
    ...
    sprintf(bufferc,"/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/example9cac3D/compare3Dtriplejunction/triplejunctioncac/dataout/datac1%d.m",kk);
    sprintf(bufferc2,"/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/example9cac3D/compare3Dtriplejunction/triplejunctioncac/dataout/datac2%d.m",kk);
    sprintf(bufferc3,"/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/example9cac3D/compare3Dtriplejunction/triplejunctioncac/dataout/datac3%d.m",kk);
    sprintf(bufferc4,"/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/example9cac3D/compare3Dtriplejunction/triplejunctioncac/dataout/datac4%d.m",kk);
