...
int main()
{
    ...
    myr = fopen("/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/example9cac3D/4component/b/dataout/Mene.m","w");
    myq = fopen("/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/example9cac3D/4component/b/dataout/Oene.m","w");
...
void initialization(float ***c, float ***c2, float ***c3, float ***c4)
{
   ...
   c[i][j][k] = 1.0/5.0 + 0.01*(2.0*rand()/(float)RAND_MAX - 1.0);
   
   c2[i][j][k] = 1.0/5.0 + 0.01*(2.0*rand()/(float)RAND_MAX - 1.0);
    c3[i][j][k] = 1.0/5.0 + 0.01*(2.0*rand()/(float)RAND_MAX - 1.0);
...
void print_data(float ***c1,float ***c2,float ***c3, float ***c4, int kk)
{
   ...
   int i,j,k;
    ...
    sprintf(bufferc,"/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/example9cac3D/4component/b/dataout/datac1%d.m",kk);
    sprintf(bufferc2,"/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/example9cac3D/4component/b/dataout/datac2%d.m",kk);
    sprintf(bufferc3,"/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/example9cac3D/4component/b/dataout/datac3%d.m",kk);
    sprintf(bufferc4,"/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/example9cac3D/4component/b/dataout/datac4%d.m",kk);
