...
int main()
{
    ...
    sprintf(bufferc,"/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/cacexample2stability/s2/stability00025/outdata/datac.m");
    sprintf(bufferc2,"/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/cacexample2stability/s2/stability00025/outdata/datac2.m");
    sprintf(bufferc3,"/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/cacexample2stability/s2/stability00025/outdata/datac3.m");
   ...
   save as row//
    ...
    myr = fopen("/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/cacexample2stability/s2/stability00025/outdata/Mene.m","w");
    myq = fopen("/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/cacexample2stability/s2/stability00025/outdata/Oene.m","w");
...
void initialization(double **c, double **c2, double **c3)
{
    ...
    c[i][j] = 1.0/3.0 + 0.01*(2.0*rand()/(float)RAND_MAX - 1.0);
   
    c2[i][j] = 1.0/3.0 + 0.01*(2.0*rand()/(float)RAND_MAX - 1.0);
