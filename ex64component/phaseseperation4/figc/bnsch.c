...
int main()
{
    ...
    sprintf(bufferc,"/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/cacexample44component/phaseseperation4/figc/dataout/datac.m");
    sprintf(bufferc2,"/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/cacexample44component/phaseseperation4/figc/dataout/datac2.m");
    sprintf(bufferc3,"/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/cacexample44component/phaseseperation4/figc/dataout/datac3.m");
    sprintf(bufferc4,"/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/cacexample44component/phaseseperation4/figc/dataout/datac4.m");
    ...
    myr = fopen("/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/cacexample44component/phaseseperation4/figc/dataout/Mene.m","w");
    myq = fopen("/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/cacexample44component/phaseseperation4/figc/dataout/Oene.m","w");
...
void initialization(double **c, double **c2, double **c3,double **c4)
{
  ...
  c[i][j] = 1.0/6.0 + 0.01*(2.0*rand()/(float)RAND_MAX - 1.0);
   
   c2[i][j] = 1.0/6.0 + 0.01*(2.0*rand()/(float)RAND_MAX - 1.0);

   c3[i][j] = 1.0/6.0+0.01*(2.0*rand()/(float)RAND_MAX - 1.0);
