...
int main()
{
    ...
    sprintf(bufferc,"/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/cacexample44component/phaseseperation4/figa/dataout/datac.m");
    sprintf(bufferc2,"/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/cacexample44component/phaseseperation4/figa/dataout/datac2.m");
    sprintf(bufferc3,"/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/cacexample44component/phaseseperation4/figa/dataout/datac3.m");
    sprintf(bufferc4,"/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/cacexample44component/phaseseperation4/figa/dataout/datac4.m");
    ...
    myr = fopen("/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/cacexample44component/phaseseperation4/figa/dataout/Mene.m","w");
    myq = fopen("/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/cacexample44component/phaseseperation4/figa/dataout/Oene.m","w");
...
ijloop{
     ...
     ijloop{
      ...
      EnEM = EnEM + h*h*( 
         ...
         + 0.5*SS/Cahn*( pow(nc[i][j]-oc[i][j],2)  + pow(nc2[i][j]-oc2[i][j],2) + pow(nc3[i][j]-oc3[i][j],2) 
...
void initialization(double **c, double **c2, double **c3,double **c4)
{
  ...
  c[i][j] = 0.25 + 0.01*(2.0*rand()/(float)RAND_MAX - 1.0);
   
   c2[i][j] = 0.25 + 0.01*(2.0*rand()/(float)RAND_MAX - 1.0);

   c3[i][j] = 0.25+0.01*(2.0*rand()/(float)RAND_MAX - 1.0);
