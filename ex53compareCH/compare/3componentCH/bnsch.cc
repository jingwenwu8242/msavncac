...
int main()
{
    ...
    sprintf(bufferc,"/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/cacexample3compareCH/compare/dataout/3componentCH/datac.m");
    sprintf(bufferc2,"/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/cacexample3compareCH/compare/dataout/3componentCH/datac2.m");
    sprintf(bufferc3,"/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/cacexample3compareCH/compare/dataout/3componentCH/datac3.m");
   ...
   save as row//
    ...
    myr = fopen("/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/cacexample3compareCH/compare/dataout/3componentCH/Mene.m","w");
    myq = fopen("/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/cacexample3compareCH/compare/dataout/3componentCH/Oene.m","w");
    ...
    ijloop{
     ...
     ijloop{
      ...
      EnEM = EnEM + h*h*( 
         ...
         + 0.5*SS*( pow(nc[i][j]-c[i][j],2)  + pow(nc2[i][j]-c2[i][j],2)  + pow(1.0-nc[i][j]-nc2[i][j] - (1.0-c[i][j]-c2[i][j]),2)   )  );
         
     }
     
     
     EnEM = EnEM + 0.5*(3.0*r-orc);
...
void source_ini(double **c_old, double **H, double **src_c, double **src_mu)
{
    ...
    ijloop {
        ...
        src_mu[i][j] = (H[i][j] + alp[i][j])*r - SS*c_old[i][j];
    }
...
void source(double **c_old, double **cc_old, double **H, double **src_c, double **src_mu)
{
    ...
    ijloop {
        ...
        src_mu[i][j] = (H[i][j] + alp[i][j])*int_r - SS*(2.0*c_old[i][j]-cc_old[i][j]);
    }
