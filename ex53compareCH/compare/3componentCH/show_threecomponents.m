...
[xx,yy]=meshgrid(x,y);
dt = 0.04*h; max_it=3000;
time = dt*max_it;
ns = max_it/20;

ss=sprintf('/Users/wujingwen/research/fluid_mechanics/SAV+multi-component incompressible fluid system/msav+nc/example3compareSAVs/compare/datdaout3componentcompare/3componentcompare/datac.m'); phi = load(ss);
ss=sprintf('/Users/wujingwen/research/fluid_mechanics/SAV+multi-component incompressible fluid system/msav+nc/example3compareSAVs/compare/datdaout3componentcompare/3componentcompare/datac2.m'); phi2 = load(ss);
ss=sprintf('/Users/wujingwen/research/fluid_mechanics/SAV+multi-component incompressible fluid system/msav+nc/example3compareSAVs/compare/datdaout3componentcompare/3componentcompare/datac3.m'); phi3 = load(ss);
ss=sprintf('/Users/wujingwen/research/fluid_mechanics/SAV+multi-component incompressible fluid system/msav+nc/example3compareSAVs/compare/datdaout3componentcompare/3componentcompare/Mene.m');EnEM1= load(ss);
ss= sprintf('/Users/wujingwen/research/fluid_mechanics/SAV+multi-component incompressible fluid system/msav+nc/example3compareSAVs/compare/datdaout3componentcompare/3componentcompare/Oene.m');EnEO1=load(ss);
