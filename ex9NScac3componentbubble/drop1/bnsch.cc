...
int main() 
{
    ...
    sprintf(bufferu, "/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/example6NScac3componentbubble/drop1/dataout/datau.m");

    sprintf(bufferv, "/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/example6NScac3componentbubble/drop1/dataout/datav.m");

    sprintf(bufferp, "/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/example6NScac3componentbubble/drop1/dataout/datap.m");

    sprintf(bufferc1, "/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/example6NScac3componentbubble/drop1/dataout/datac1.m");
    sprintf(bufferc2, "/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/example6NScac3componentbubble/drop1/dataout/datac2.m");
    sprintf(bufferc3, "/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/example6NScac3componentbubble/drop1/dataout/datac3.m");
    ...
    q = 1.0;
    oq = q; 
    auxiliary=fopen("/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/example6NScac3componentbubble/drop1/dataout/auq.m", "w");
    ...
    i0jloop { EnEO = EnEO + 0.5 * nu[i][j] * nu[i][j]; }

    ij0loop { EnEO = EnEO + 0.5 * nv[i][j] * nv[i][j]; }
     EnEO = EnEO +1;

    myr = fopen("/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/example6NScac3componentbubble/drop1/dataout/Mene.m", "w");
    myq = fopen("/Users/wujingwen/research/fluid_mechanics/msavncac/msav+ncac/example6NScac3componentbubble/drop1/dataout/Oene.m", "w");
...
void initialization(double **u, double **v, double **c1, double **c2, double **c3, double **p)
{
    ...
    ijloop
    {
        ...
        /* c1[i][j] = 0.33 + 0.01 * (2.0 * rand() / (float)RAND_MAX - 1.0);
...
/* 
            ...
            c1[i][j]=0.5+0.5*tanh((0.15-sqrt(pow(x-0.5,2)+pow(y-1.6,2)))/(2*sqrt(2)*gam));
            c2[i][j]=0.5+0.5*tanh((y-1.2)/(2*sqrt(2)*gam))-c1[i][j];
            c3[i][j]=1-c1[i][j]-c2[i][j];
            p[i][j]=0;
